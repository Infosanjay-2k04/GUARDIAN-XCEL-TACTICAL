...
import { Footprints, AlertOctagon, UserX, RadioTower, Flame, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="tactical-box p-3 rounded border border-tactical-border/90 bg-tactical-dark/95 flex flex-col gap-2.5">
      <div className="flex items-center justify-between text-[10px] font-mono border-b border-tactical-border/50 pb-1.5">
        ...
        <span className="text-tactical-cyan text-[9px]">SENDS REAL BACKEND EVENTS</span>
      </div>

      <div className="grid grid-cols-2 gap-2">
        <button
          onClick={() => trigger('NORMAL')}
          className={`flex items-center justify-center gap-1.5 p-2.5 rounded border text-xs font-mono font-bold transition-all active:scale-95 ${
